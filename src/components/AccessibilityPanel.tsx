        ...
        <div className="grid grid-cols-[1.3fr_1fr] gap-px flex-1 min-h-0 overflow-hidden">
          ...
          <div className="px-3 py-2 overflow-y-auto">
            ...
            <div className="text-3xs text-ops-dim leading-relaxed">
              ...
              <div><span className="num text-ops-text">1 2 3</span> senaryo · <span className="num text-ops-text">N</span> nominal · <span className="num text-ops-text">L T</span> küre çerçevesi · <span className="num text-ops-text">Y</span> TUSAŞ yakın · <span className="num text-ops-text">F</span> takip · <span className="num text-ops-text">0</span> hız 1×</div>
