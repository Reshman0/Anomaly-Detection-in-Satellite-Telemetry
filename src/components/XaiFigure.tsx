 ...
 *
 * Neden canli cizim: gorsel ekrandaki senaryonun kanalini ve zamanlamasini
 * birebir gostermeli. Sabit PNG'ler senaryodan kopabilir; burada cizilen her
 * sey senaryonun enjeksiyon tanimindan hesaplanir (bkz. engine/xaiFigures.ts).
 *
...
function fig(
  ...
  if (level === 1) {
    ...
    g.strokeStyle = alpha(COLOR.ai, 0.45);
    g.lineWidth = 1;
    g.beginPath();
    ...
    g.fillStyle = alpha(COLOR.ai, 0.35);
    g.beginPath();
  ...
  if (level === 2) {
    ...
    FIGURE_CHANNELS.forEach((ch, i) => {
      ...
      g.fillStyle = hedefMi ? COLOR.ai : alpha(COLOR.faint, 0.5);
  ...
  g.fillStyle = alpha(COLOR.ai, 0.4);
  g.beginPath();
